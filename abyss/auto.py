...
async def start_handler(client, message):
    list_ID = [{'ID': '0boKP8Xze', 'name_en': 'My Boss, My Hero'}, {'ID': '2taGB0eld', 'name_en': 'The Mummy'}, {'ID': 'cTaFsuaNeO', 'name_en': 'The Mummy Returns'}, {'ID': 'Fkp3ehLDK', 'name_en': 'The Mummy Resurrected'}, {'ID': 'mJ4L0ZEid', 'name_en': 'The Mummy Tomb of The Dragon Emperor'}, {'ID': 'Bs-pizpr-', 'name_en': 'Frankenstein vs The Mummy'}, {'ID': 'Ryd9h2tba', 'name_en': 'The Mummy'}, {'ID': 'PhwOiBic0', 'name_en': 'Pod'}]
    for item in list_ID:
        ID = item['ID']

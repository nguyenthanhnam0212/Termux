...
def save(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
	...
	for i in msgid:
		...
		print(f"\rID {i} Completed... / {to_id-1}", end='', flush=True)
		# joining chats
...
__send public/private posts link as explained above with formate "từ - đến" to send multiple messages like below__
